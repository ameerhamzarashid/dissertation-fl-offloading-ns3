...
scripts lay out results: results/exp2/seed_<n>/raw_ns3).
"""
...
def main():
    ap = argparse.ArgumentParser(description="Exp2: ingest NS-3 logs and write per-round metrics")
    ...
    print(f"[exp2] wrote {len(rounds)} rows -> {out_csv}")
